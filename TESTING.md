...
- [Index/Home](testing/w3/home-w3.png) - Passed with no errors or warnings.
- [Experience](testing/w3/experience-w3.png) - Passed with no errors or warnings.
- [Projects](testing/w3/projects-w3.png) - Passed with no errors or warnings. I did need to go back to my HTML and troubleshoot some errors initially relating to a stray " left when I moved my .active class for my navbar styling.
- [Contact](testing/w3/w3-contact.png) - Passed with no errors or warnings. Needed to remove a mis-placed alt tag in response to initial errors on the page.
...
- [CSS](testing/w3/jigsaw-css.png) - No errors found.
...
![Home-desktop](testing/lighthouse/home-desktop.png)
![Experience-desktop](testing/lighthouse/exp-desktop.png)
![Projects-desktop](testing/lighthouse/projects-desktop.png)
![Contact-desktop](testing/lighthouse/contact-desktop.png)

#### Desktop Results - After

![Home-after](testing/lighthouse/contact-desktop-after.png)
![Experience-after](testing/lighthouse/exp-desktop-after.png)
![Projects-after](testing/lighthouse/projects-desktop-after.png)
![Contacts-after](testing/lighthouse/contact-desktop-after.png)

As you can see - the few minor changes increased my metrics pretty significantly.

#### Mobile Results - Before

![home-mobile](testing/lighthouse/home-mobile.png)
![exp-mobile](testing/lighthouse/exp-mobile.png)
![projects-mobile](testing/lighthouse/projects-mobile.png)
![contact-mobile](testing/lighthouse/contact-mobile.png)

#### Mobile Results - After

![home-mob-after](testing/lighthouse/home-mobile-after.png)
![exp-mob-after](testing/lighthouse/exp-mobile-after.png)
![project-mob-after](testing/lighthouse/projects-mobile-after.png)
![contact-mob-after](testing/lighthouse/contact-mobile-after.png)
...
![saf-fs](testing/safari/safar-fullscreen.png)
![saf-hs](testing/safari/safar-half.png)
![saf-smol](testing/safari/safar-smol.png)

#### Dev Tool View - All pages

![dev-home](testing/safari/dev-home.png)
![dev-exp](testing/safari/dev-experience.png)
![dev-project](testing/safari/dev-projects.png)
![dev-contact](testing/safari/dev-contact.png)
